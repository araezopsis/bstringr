...
bstr_align <-
  function(seq1, seq2){
    ...
    Biostrings::pairwiseAlignment(subject = seq1, pattern = seq2, type = "overlap")
  }
...
dstr_multi_align <-
  function(subject, queries){
    ...
    list(
      "forward" = bstr_align(subject, queries),
      "reverse" = bstr_align(subject, dstr_rc(queries))
    )
  }
